...
@Serializable(with = FavoriteSortingTypeApi.Companion.Serializer::class)
enum class FavoriteSortingTypeApi(val value: String) {
    ...
    companion object {
        object Serializer : KSerializer<FavoriteSortingTypeApi?> by EnumSerializer.create<FavoriteSortingTypeApi>()
    }
}