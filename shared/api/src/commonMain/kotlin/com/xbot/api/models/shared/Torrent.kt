...
data class Torrent(
    ...
    @SerialName("type") val type: TorrentTypeEnum,
    @SerialName("label") val label: String,
    @SerialName("magnet") val magnet: String,
    @SerialName("filename") val fileName: String,
    @SerialName("seeders") val seeders: Int,
    @SerialName("quality") val quality: QualityEnum,
    @SerialName("codec") val codec: CodecEnum,
    @SerialName("color") val color: ColorDepthEnum,
