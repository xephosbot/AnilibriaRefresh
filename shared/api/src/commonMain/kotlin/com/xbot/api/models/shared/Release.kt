...
data class Release(
    ...
    @SerialName("type") val type: ReleaseTypeEnum?,
    @SerialName("year") val year: Int,
    @SerialName("name") val name: Name,
    @SerialName("alias") val alias: String,
    @SerialName("season") val season: SeasonEnum?,
    ...
    @SerialName("age_rating") val ageRating: AgeRatingEnum,
    @SerialName("publish_day") val publishDay: PublishDayEnum,
