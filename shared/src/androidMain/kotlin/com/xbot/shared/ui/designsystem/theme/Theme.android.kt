...
import com.xbot.shared.ui.designsystem.components.AnilibriaNavigationBar
import com.xbot.shared.ui.designsystem.components.AnilibriaNavigationRail
...
@Composable
internal fun selectSchemeForContrast(darkTheme: Boolean): ColorScheme {
    val context = LocalContext.current
