...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("org.jetbrains.compose.material3:material3:1.8.10-alpha01")
            implementation("org.jetbrains.compose.material3:material3-adaptive-navigation-suite:1.8.10-alpha01")
