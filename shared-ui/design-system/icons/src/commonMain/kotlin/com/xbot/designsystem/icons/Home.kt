...
val AnilibertyIcons.Filled.Home: ImageVector
    get() {
        if (_homeFilled != null) {
            return _homeFilled!!
        }
            ...
            Builder(
                ...
                .apply {
                    path(
                        ...
                        quadTo(583.0f, 840.0f, 571.5f, 828.5f)
                        quadTo(560.0f, 817.0f, 560.0f, 800.0f)
                        lineTo(560.0f, 600.0f)
                        quadTo(560.0f, 583.0f, 548.5f, 571.5f)
                        quadTo(537.0f, 560.0f, 520.0f, 560.0f)
                        lineTo(440.0f, 560.0f)
                        quadTo(423.0f, 560.0f, 411.5f, 571.5f)
                        quadTo(400.0f, 583.0f, 400.0f, 600.0f)
                        lineTo(400.0f, 800.0f)
                        quadTo(400.0f, 817.0f, 388.5f, 828.5f)
                        quadTo(377.0f, 840.0f, 360.0f, 840.0f)
...
@Suppress("UnusedReceiverParameter")
val AnilibertyIcons.Outlined.Home: ImageVector
    get() {
