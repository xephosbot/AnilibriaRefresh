rootProject.name = "AnilibertyRefresh"
...
include(":shared:core:data:api")
include(":shared:core:data:impl")
include(":shared:core:data:test-fixtures")
include(":shared:core:domain:api")
include(":shared:core:domain:impl")
include(":shared:core:domain:test-fixtures")
include(":shared:core:logger:api")
include(":shared:core:logger:impl")
...
include(":shared-ui:navigation:scene")
include(":shared-ui:design-system:theme")
include(":shared-ui:design-system:components")
include(":shared-ui:design-system:icons")
