...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final StickyLibraryAccessors laccForStickyLibraryAccessors = new StickyLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>brotli</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    /**
     * Group of libraries at <b>sticky</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public StickyLibraryAccessors getSticky() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForStickyLibraryAccessors;
    }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getInterpolator() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.interpolator");
        }
    ...
    public static class AndroidxComposeBomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>alpha</b> with <b>androidx.compose:compose-bom-alpha</b> coordinates and
         * with version reference <b>androidxComposeBomAlpha</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getAlpha() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.compose.bom.alpha");
        }
    ...
    public static class AndroidxMedia3LibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxMedia3UiLibraryAccessors laccForAndroidxMedia3UiLibraryAccessors = new AndroidxMedia3UiLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.media3.ui</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxMedia3UiLibraryAccessors getUi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxMedia3UiLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxMedia3UiLibraryAccessors extends SubDependencyFactory {

        public AndroidxMedia3UiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.media3.ui.compose");
        }
    ...
    public static class AndroidxPagingLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>androidx.paging:paging-common</b> coordinates and
         * with version reference <b>paging</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.paging.core");
        }
    ...
    public static class BrotliLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>dec</b> with <b>org.brotli:dec</b> coordinates and
    ...
    public static class KotlinxCollectionsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>kotlinxCollections</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory {
        private final MaterialMotionLibraryAccessors laccForMaterialMotionLibraryAccessors = new MaterialMotionLibraryAccessors(owner);

        public MaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>material.motion</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MaterialMotionLibraryAccessors getMotion() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMaterialMotionLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MaterialMotionLibraryAccessors extends SubDependencyFactory {
        private final MaterialMotionComposeLibraryAccessors laccForMaterialMotionComposeLibraryAccessors = new MaterialMotionComposeLibraryAccessors(owner);

        public MaterialMotionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>material.motion.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MaterialMotionComposeLibraryAccessors getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMaterialMotionComposeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MaterialMotionComposeLibraryAccessors extends SubDependencyFactory {

        public MaterialMotionComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>io.github.fornewid:material-motion-compose-core</b> coordinates and
         * with version reference <b>materialMotionCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("material.motion.compose.core");
        }
     ...
     */
    @Deprecated
    public static class StickyLibraryAccessors extends SubDependencyFactory {

        public StickyLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>headers</b> with <b>me.gingerninja.lazy:sticky-headers</b> coordinates and
         * with version reference <b>stickyHeaders</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidDesugarJdkLibs</b> with value <b>2.1.5</b>
         * <p>
        ...
        /**
         * Version alias <b>androidxActivity</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeBom</b> with value <b>2025.02.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeBomAlpha</b> with value <b>2025.02.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxComposeBomAlpha() { return getVersion("androidxComposeBomAlpha"); }

        /**
         * Version alias <b>androidxCore</b> with value <b>1.15.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxCoreSplashscreen</b> with value <b>1.2.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxDataStore</b> with value <b>1.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxEspresso</b> with value <b>3.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxLifecycle</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxMacroBenchmark</b> with value <b>1.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxNavigation</b> with value <b>2.8.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxProfileinstaller</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koin</b> with value <b>4.1.0-Beta5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinCompiler</b> with value <b>1.5.15</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinCompiler() { return getVersion("kotlinCompiler"); }

        /**
         * Version alias <b>kotlinxCollections</b> with value <b>0.3.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxCollections() { return getVersion("kotlinxCollections"); }

        /**
         * Version alias <b>kotlinxCoroutines</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ksp</b> with value <b>2.1.10-1.0.30</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktor</b> with value <b>3.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialMotionCompose</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterialMotionCompose() { return getVersion("materialMotionCompose"); }

        /**
         * Version alias <b>media3</b> with value <b>1.6.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>nativecoroutines</b> with value <b>1.0.0-ALPHA-38</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNativecoroutines() { return getVersion("nativecoroutines"); }
        ...
        /**
         * Version alias <b>shimmer</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>skie</b> with value <b>0.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>stickyHeaders</b> with value <b>0.1.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStickyHeaders() { return getVersion("stickyHeaders"); }
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.tools</b> with value <b>31.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidGradleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.gradle.plugin</b> with value <b>8.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final XbotPluginAccessors paccForXbotPluginAccessors = new XbotPluginAccessors(providers, config);
        ...
        /**
         * Plugin provider for <b>nativecoroutines</b> with plugin id <b>com.rickclephas.kmp.nativecoroutines</b> and
         * with version reference <b>nativecoroutines</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getNativecoroutines() { return createPlugin("nativecoroutines"); }
        ...
        /**
         * Group of plugins at <b>plugins.xbot</b>
         */
        public XbotPluginAccessors getXbot() {
            return paccForXbotPluginAccessors;
        }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        private final KotlinMultiplatformPluginAccessors paccForKotlinMultiplatformPluginAccessors = new KotlinMultiplatformPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.kotlin.multiplatform</b>
         */
        public KotlinMultiplatformPluginAccessors getMultiplatform() {
            return paccForKotlinMultiplatformPluginAccessors;
        }

    }

    public static class KotlinMultiplatformPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        private final KotlinMultiplatformAndroidPluginAccessors paccForKotlinMultiplatformAndroidPluginAccessors = new KotlinMultiplatformAndroidPluginAccessors(providers, config);

        public KotlinMultiplatformPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
         ...
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("kotlin.multiplatform"); }

        /**
         * Group of plugins at <b>plugins.kotlin.multiplatform.android</b>
         */
        public KotlinMultiplatformAndroidPluginAccessors getAndroid() {
            return paccForKotlinMultiplatformAndroidPluginAccessors;
        }

    }

    public static class KotlinMultiplatformAndroidPluginAccessors extends PluginFactory {

        public KotlinMultiplatformAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>kotlin.multiplatform.android.library</b> with plugin id <b>com.android.kotlin.multiplatform.library</b> and
         * with version reference <b>android.gradle.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getLibrary() { return createPlugin("kotlin.multiplatform.android.library"); }

    }

    public static class XbotPluginAccessors extends PluginFactory {

        public XbotPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>xbot.compose</b> with plugin id <b>com.xbot.compose</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("xbot.compose"); }
